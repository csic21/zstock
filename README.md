...
| **AI 策略实验室** | 标题栏「策略实验室」：冻结数据集，生成 3–5 个白名单 DSL 策略，在后台执行组合回测、walk-forward/成本压力/参数邻域检验，查看确定性排行榜与逐笔交易，并将过门槛版本加入幂等模拟观察；详见 [使用与研究约束](docs/strategy-lab.md) |
